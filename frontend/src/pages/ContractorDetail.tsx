...
import { TECHNOLOGY_CONFIG, STATUS_CONFIG, CONTRACTOR_ROLE_CONFIG } from '../lib/types'
import type { Technology, ProjectStatus, ProjectSummary, ContractorRole } from '../lib/types'
