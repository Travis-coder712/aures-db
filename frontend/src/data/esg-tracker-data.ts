...
export const ESG_TRACKER_PROJECTS: ESGTrackerProject[] = [
  ...
  // ────────────────────────────────────────────────
  // CIS Tender 7 — NEM Generation (announced 2026-05-23)
  // 15 of 19 winners named in initial RenewEconomy article; 4 pending DCCEEW media release.
  ...
  // ────────────────────────────────────────────────
  {
    ...
    capacityMW: 1450, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: 'Australia\'s biggest wind project. Origin Energy is CEC signatory. SW REZ access right held.',
  },
  {
    name: 'Baldin (Baldon Stage 2) Wind+BESS', projectId: 'baldon-wind-farm-stage-2', developer: 'Goldwind Australia',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 346, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Awaiting IPC determination; RTS lodged with DPHI May 2025.',
  },
  {
    name: 'Bullewah (Bullawah Stage 1) Wind', projectId: 'bullawah-wind-farm-stage-1', developer: 'BayWa r.e.',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 283, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Capacity awarded matches 283 MW SW REZ access right. Full ~804 MW project; Stage 2 separately a Q2 2026 LTESA candidate.',
  },
  {
    name: 'Birriwa Solar + BESS', projectId: 'birriwa-solar-farm', developer: 'ACEN Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
  ...
  {
    name: 'Dinawan Solar (Dinawan Energy Hub)', projectId: 'dinawan-energy-hub', developer: 'Spark Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Solar+battery component of Dinawan Energy Hub (separate from 357 MW wind Stage 1 CIS T4 win). Capacity not disclosed in initial article.',
  },
  {
    name: 'Kayuga Solar', projectId: null, developer: 'Undisclosed',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'NSW', stage: 'unknown',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Capacity not disclosed; project ID not yet matched in AURES DB.',
  },
  {
    name: 'Bungaban Wind + Battery', projectId: 'bungaban-wind-farm', developer: 'Windlab',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 1150, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '1,150 MW wind + 1,450 MWh battery. Long-term PPA with Rio Tinto for Gladstone-area smelter/refinery power.',
  },
  {
    name: 'Theodore Wind Farm', projectId: 'theodore-wind-farm', developer: 'RWE Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 1000, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: 'Previously threatened by QLD LNP. RWE is CEC signatory.',
  },
  {
    name: 'Bullyard Solar Farm', projectId: 'bullyard-solar-farm', developer: 'European Energy',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Capacity not disclosed. Likely to add battery storage outside CIS parameters.',
  },
  {
  ...
  },
  {
    ...
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 70, state: 'VIC', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
  },
  {
    name: 'Whyte Yarcowie Wind Farm', projectId: 'whyte-yarcowie', developer: 'EdF Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'SA', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'SA\'s only T7 winner. Capacity not disclosed in initial article.',
  },
  {
    name: 'Cellars Hill Wind Farm', projectId: null, developer: 'Gamuda',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'TAS', stage: 'unknown',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Project ID not yet matched in AURES DB. Capacity not disclosed.',
  },
  {
    name: 'Weasel Solar Farm', projectId: 'weasel-solar-farm-and-bess-kci', developer: 'Gamuda',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 0, state: 'TAS', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Unusual: major solar farm on Tasmanian central highlands. Capacity not disclosed.',
  },
  // 4 winners unnamed in RenewEconomy initial article — refresh once DCCEEW media release lands
]
