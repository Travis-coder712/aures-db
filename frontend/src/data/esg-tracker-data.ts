...
export const ROUND_ESG_SUMMARIES: RoundESGSummary[] = [
  ...
  {
    roundId: 'ltesa-round-7',
    scheme: 'LTESA',
    round: 'Round 7 — Firming Supply & Demand Response',
    announcedDate: '2026-05-15',
    publicationRequired: true,
    meritCriteriaVersion: 'EII Act 2020 — Revised General First Nations Guidelines (May 2025)',
  },
  {
    roundId: 'cis-tender-7-nem-gen',
    scheme: 'CIS',
    round: 'Tender 7 — NEM Generation',
    announcedDate: '2026-05-23',
    publicationRequired: true,
    meritCriteriaVersion: 'Strengthened MC4 + MC8 — heaviest FN merit weighting to date; 4/19 winners unnamed pending DCCEEW media release',
  },
]
...
export const ESG_TRACKER_PROJECTS: ESGTrackerProject[] = [
  ...
  // ────────────────────────────────────────────────
  // LTESA Round 7 — Firming Supply & Demand Response (announced 2026-05-15)
  // ────────────────────────────────────────────────
  {
    name: 'Tomago Battery', projectId: 'tomago-battery', developer: 'AGL Energy',
    scheme: 'LTESA', round: 'Round 7 — Firming Supply & Demand Response', roundId: 'ltesa-round-7',
    capacityMW: 500, state: 'NSW', stage: 'construction',
    agreementStatus: 'executed', awardAnnouncedDate: '2026-05-15',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: '500 MW / 2,000 MWh 8-hour battery near Newcastle. Fluence supply contract executed.',
  },
  {
    name: 'Sydney / Newcastle VPP', projectId: null, developer: 'Enel X Australia',
    scheme: 'LTESA', round: 'Round 7 — Firming Supply & Demand Response', roundId: 'ltesa-round-7',
    capacityMW: 32, state: 'NSW', stage: 'unknown',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-15',
    publicationStatus: 'exempt',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Sydney + Newcastle business-customer VPP. VPPs are typically exempt from site-specific FN requirements.',
  },

  // ────────────────────────────────────────────────
  // CIS Tender 7 — NEM Generation (announced 2026-05-23, refreshed 2026-05-25)
  // All 19 winners now named (DCCEEW media release published 2026-05-24).
  // All entries publicationStatus 'too_early' — 20-business-day window from CISA execution.
  // ────────────────────────────────────────────────
  {
    name: 'Yanco Delta Wind Farm', projectId: 'yanco-delta-wind-farm', developer: 'Origin Energy',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 1498, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: 'Australia\'s biggest wind project. Origin Energy is CEC signatory. SW REZ access right held (full 1,460 MW).',
  },
  {
    name: 'Birriwa Solar + BESS', projectId: 'birriwa-solar-farm', developer: 'ACEN Australia',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 600, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: true, cecCharterSignatory: true, aslSummaryData: true,
    notes: 'Largest solar+BESS hybrid in T7 (600 MW solar + 2,400 MWh battery).',
  },
  {
    name: 'Baldin / Baldon Stage 2', projectId: 'baldon-wind-farm-stage-2', developer: 'Goldwind / Omni',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 346, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '346 MW wind + 132 MWh BESS. Awaiting IPC determination; RTS lodged with DPHI May 2025.',
  },
  {
    name: 'Gundary Solar Hybrid', projectId: 'gundary-solar-farm-and-bess', developer: 'Lightsource bp',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 320, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: '320 MW solar + 1,391 MWh BESS. Lightsource bp is CEC signatory.',
  },
  {
    name: 'Bullewah / Bullawah Stage 1', projectId: 'bullawah-wind-farm-stage-1', developer: 'BayWa r.e.',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 300, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'DCCEEW awarded 300 MW (vs 283 MW SW REZ access right). Full ~804 MW project; Stage 2 separately a Q2 2026 LTESA candidate.',
  },
  {
    name: 'Dinawan Solar Hybrid', projectId: 'dinawan-energy-hub', developer: 'Spark Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 300, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '300 MW solar + 1,200 MWh BESS — Dinawan Energy Hub solar+BESS component. Separate from 357 MW wind Stage 1 CIS T4 win.',
  },
  {
    name: 'Gunning Solar Farm Hybrid', projectId: null, developer: 'Zero-E / Grupo Cobra',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 290, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '290 MW solar + 542 MWh BESS at Lade Vale. New project — not yet in AURES DB (separate from operating Gunning Wind Farm 46 MW). Spanish construction conglomerate Grupo Cobra via Zero-E subsidiary.',
  },
  {
    name: 'Wattle Creek Solar Hybrid', projectId: 'wattle-creek-energy-hub-solar-bess', developer: 'Spark Renewables',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 180, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '180 MW solar + 720 MWh BESS — Wattle Creek Energy Hub solar+BESS component. Spark Renewables\' second T7 win (alongside Dinawan).',
  },
  {
    name: 'Kayuga Solar Farm and BESS', projectId: null, developer: 'European Energy Australia',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 85, state: 'NSW', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'New project — not yet in AURES DB. DCCEEW labels as solar only (no BESS MWh disclosed despite the "and BESS" in project name).',
  },
  {
    name: 'Bungaban Wind Energy Project', projectId: 'bungaban-wind-farm', developer: 'Windlab',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 1150, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '1,150 MW wind + 1,400 MWh battery. Long-term PPA with Rio Tinto for Gladstone-area smelter/refinery power.',
  },
  {
    name: 'Theodore Wind Farm', projectId: 'theodore-wind-farm', developer: 'Theodore Energy Development',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 1022, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Previously threatened by QLD LNP. Now backed by a dedicated Theodore Energy Development SPV.',
  },
  {
    name: 'Banana Range Wind Farm', projectId: 'banana-range-wind-farm', developer: 'EDF Power Solutions',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 228, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'EDF\'s first of two T7 wins (Whyte Yarcowie SA the other).',
  },
  {
    name: 'Moranbah Solar Farm', projectId: null, developer: 'Zero-E / Grupo Cobra',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 171, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: '171 MW solar + 100 MWh BESS. New project — not yet in AURES DB. Grupo Cobra\'s second T7 win.',
  },
  {
    name: 'Bullyard Solar Farm', projectId: 'bullyard-solar-farm', developer: 'European Energy Australia',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 97, state: 'QLD', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'European Energy Australia\'s second T7 win alongside Kayuga (NSW).',
  },
  {
    name: 'Cellars Hill Wind Farm', projectId: null, developer: 'Gamuda Renewables / Alternate Path',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 341, state: 'TAS', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'New project — not yet in AURES DB. Gamuda + Alternate Path JV; sister project to Weasel Solar.',
  },
  {
    name: 'Weasel Solar Farm', projectId: 'weasel-solar-farm-and-bess-kci', developer: 'Gamuda Renewables / Alternate Path',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 200, state: 'TAS', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Unusual: major solar farm on Tasmanian central highlands. DCCEEW announcement labels as solar only.',
  },
  {
    name: 'Whyte Yarcowie Wind Farm', projectId: 'whyte-yarcowie', developer: 'EDF Power Solutions',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 289, state: 'SA', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'SA\'s only T7 winner. EDF\'s second of two T7 wins.',
  },
  {
    name: 'Willatook Wind Farm', projectId: 'willatook', developer: 'ENGIE',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 338, state: 'VIC', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: true, aslSummaryData: true,
    notes: 'Victoria sought only wind in T7. ENGIE is CEC signatory.',
  },
  {
    name: 'Woolsthorpe Wind Farm', projectId: 'woolsthorpe-wind-farm', developer: 'ICA Partners',
    scheme: 'CIS', round: 'Tender 7 — NEM Generation', roundId: 'cis-tender-7-nem-gen',
    capacityMW: 72, state: 'VIC', stage: 'development',
    agreementStatus: 'awarded', awardAnnouncedDate: '2026-05-23',
    publicationStatus: 'too_early',
    fncenListed: false, cecCharterSignatory: false, aslSummaryData: true,
    notes: 'Mexican construction conglomerate ICA Partners — smallest T7 winner.',
  },
]
