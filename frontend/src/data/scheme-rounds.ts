...
export const CIS_PROJECTS: Record<string, SchemeProject[]> = {
  'cis-tender-1-nem-gen': [
    ...
    { name: 'Barwon Solar Farm', developer: 'Elgin Energy', technology: 'hybrid', capacity_mw: 250, storage_mwh: 500, state: 'VIC', project_id: 'barwon-solar-farm-and-bess', contract_status: 'awarded' , notes: 'Dev approval 2024. AEMO 5.3.4A connection approval secured May 2025. Environment report exhibited Nov-Dec 2025. AU$195m. 16-month build once started.' },
    { name: 'Campbells Forest Solar Farm', developer: 'Risen Energy', technology: 'solar', capacity_mw: 205, state: 'VIC', project_id: 'campbells-forest-solar-farm', contract_status: 'fid' , notes: 'Financial close targeted Q4 2025. Construction planned Q1 2026. GPS approved by AEMO.' },
    { name: 'Elaine Solar Farm', developer: 'Elgin Energy', technology: 'hybrid', capacity_mw: 125, storage_mwh: 250, state: 'VIC', project_id: 'elaine-solar-farm-and-bess', contract_status: 'awarded' , notes: 'AEMO 5.3.4A technical approval May 2025. Construction scheduled 2026, operations 2027. Copenhagen Infrastructure Partners now majority owner of Elgin.' },
    { name: 'Barnawartha Solar Farm', developer: 'Gentari', technology: 'hybrid', capacity_mw: 64, storage_mwh: 139, state: 'VIC', project_id: 'barnawartha-solar-and-energy-storage', contract_status: 'awarded' , notes: 'CIS T1 awarded Dec 2024. Target energisation 2027. No confirmed FID.' },
    // SA (2 projects)
    ...
    { name: 'Majors Creek Solar Power Station', developer: 'Edify Energy', technology: 'hybrid', capacity_mw: 150, storage_mwh: 600, state: 'QLD', project_id: 'majors-creek-solar-power-station', contract_status: 'fid' , notes: 'EPC contractor DT Infrastructure appointed Mar 2026. Construction H1 2026. Operational target 2028. Combined 300 MW solar + 1,200 MWh BESS with Ganymirra.' },
    { name: 'Ganymirra Solar Power Station', developer: 'Edify Energy', technology: 'hybrid', capacity_mw: 150, storage_mwh: 600, state: 'QLD', project_id: 'ganymirra-solar-power-station', contract_status: 'fid' , notes: 'EPC contractor DT Infrastructure appointed Mar 2026. Construction H1 2026. Combined project with Majors Creek. ~420 jobs, AU$450m+.' },
    // VIC — 19th project
    { name: 'Mokoan Solar Farm', developer: 'European Energy Australia', technology: 'solar', capacity_mw: 46, state: 'VIC', project_id: 'mokoan-solar-farm', contract_status: 'operating' },
  ],
  'cis-pilot-nsw': [
  ...
  'cis-tender-4-nem-gen': [
    { name: 'Bell Bay Wind Farm', developer: 'Equis', technology: 'wind', capacity_mw: 224, state: 'TAS', contract_status: 'awarded', project_id: undefined },
    ...
    { name: 'Bundey BESS and Solar', developer: 'Genaspi Energy Group', technology: 'hybrid', capacity_mw: 240, storage_mwh: 1200, state: 'SA', project_id: 'bundey-bess-and-solar-project', contract_status: 'awarded' , notes: 'Stage 1 of 1,200 MW/3,900 MWh. Connections Agreement Q2 2026. Full approval Q1-Q2 2026.' },
    { name: 'Carmody\'s Hill Wind Farm', developer: 'Aula Energy', technology: 'wind', capacity_mw: 247, state: 'SA', project_id: 'carmodys-hill-wind-farm', contract_status: 'construction' },
    { name: 'Corop Solar Farm and BESS', developer: 'BNRG Leeson', technology: 'hybrid', capacity_mw: 230, storage_mwh: 704, state: 'VIC', project_id: 'corop-solar-farm', contract_status: 'awarded' , notes: 'EPBC cleared in ~4 months. Construction expected Q1 2026, 2-year build. ~700 jobs. 1.19M solar modules.' },
    { name: 'Derby Solar Project', developer: 'Sungrow', technology: 'hybrid', capacity_mw: 95, storage_mwh: 210, state: 'VIC', contract_status: 'awarded', project_id: 'derby-solar-farm-and-bess' },
    ...
    { name: 'Gawara Baya', developer: 'Windlab', technology: 'hybrid', capacity_mw: 399, storage_mwh: 217, state: 'QLD', project_id: 'gawara-baya-wind-and-bess', contract_status: 'fid' , notes: 'All regulatory approvals secured (federal Jun 2024, state Aug 2023). Construction may commence Q1 2026 subject to FC. 69 turbines.' },
    { name: 'Guthrie\'s Gap Solar Power Station', developer: 'Edify Energy', technology: 'hybrid', capacity_mw: 300, storage_mwh: 1200, state: 'QLD', contract_status: 'awarded', project_id: 'guthries-gap-solar-power-station' },
    ...
    { name: 'Lower Wonga Solar Farm', developer: 'Lightsource bp', technology: 'solar', capacity_mw: 281, state: 'QLD', contract_status: 'awarded', project_id: 'lower-wonga-solar-farm-and-bess' },
    ...
    { name: 'Moah Creek Wind Farm', developer: 'Central Queensland Power', technology: 'wind', capacity_mw: 360, state: 'QLD', project_id: 'moah-creek-wind-farm', contract_status: 'awarded' , notes: 'CleanCo partnership. AU$600m, ~400 jobs. Development phase completing mid-2025.' },
    { name: 'Nowingi Solar Power Station', developer: 'Edify Energy', technology: 'hybrid', capacity_mw: 300, storage_mwh: 1200, state: 'VIC', project_id: 'nowingi-solar-farm-edify-kci', contract_status: 'awarded' , notes: 'EPBC cleared Sep 2025. Australias largest duration BESS (8-hour). Construction targeted 2026, ~18 months build.' },
    { name: 'Punchs Creek Solar Farm', developer: 'EDPR', technology: 'hybrid', capacity_mw: 400, storage_mwh: 1600, state: 'QLD', contract_status: 'awarded' },
    { name: 'Smoky Creek Solar Power Station', developer: 'Edify Energy', technology: 'hybrid', capacity_mw: 300, storage_mwh: 1200, state: 'QLD', contract_status: 'awarded', project_id: 'smoky-creek-solar-power-station' },
    ...
    { name: 'Willogoleche 2 Wind Farm', developer: 'ENGIE / Foresight', technology: 'wind', capacity_mw: 108, state: 'SA', contract_status: 'awarded', project_id: 'willogoleche-wind-farm' },
  ],
  'cis-tender-7-nem-gen': [
    ...
    { name: 'Bungaban Wind Energy Project', developer: 'Windlab', technology: 'hybrid', capacity_mw: 1150, storage_mwh: 1400, state: 'QLD', project_id: 'bungaban-wind-farm', contract_status: 'fid', notes: '1,150 MW wind + 1,400 MWh battery. Long-term PPA with Rio Tinto for smelter/refinery power.' },
    ...
    { name: 'Banana Range Wind Farm', developer: 'EDF Power Solutions', technology: 'wind', capacity_mw: 228, state: 'QLD', project_id: 'banana-range-wind-farm', contract_status: 'awarded', notes: 'EDF Renewables\' second T7 win alongside Whyte Yarcowie (SA).' },
    { name: 'Moranbah Solar Farm', developer: 'Zero-E / Grupo Cobra', technology: 'hybrid', capacity_mw: 171, storage_mwh: 100, state: 'QLD', contract_status: 'awarded', notes: 'New project — not yet in AURES DB. Grupo Cobra\'s second T7 win (with Gunning Solar Hybrid NSW). Small BESS (100 MWh) relative to gen size — primarily firming the solar shape.' },
    { name: 'Bullyard Solar Farm', developer: 'European Energy Australia', technology: 'solar', capacity_mw: 97, state: 'QLD', project_id: 'bullyard-solar-farm', contract_status: 'awarded', notes: 'European Energy Australia\'s second T7 win alongside Kayuga (NSW).' },
    // TAS (2 projects — 1 wind / 1 solar)
    { name: 'Cellars Hill Wind Farm', developer: 'Gamuda Renewables / Alternate Path', technology: 'wind', capacity_mw: 341, state: 'TAS', contract_status: 'awarded', notes: 'New project — not yet in AURES DB. Gamuda + Alternate Path JV; sister project to Weasel Solar.' },
    { name: 'Weasel Solar Farm', developer: 'Gamuda Renewables / Alternate Path', technology: 'solar', capacity_mw: 200, state: 'TAS', contract_status: 'awarded', project_id: 'weasel-solar-farm-and-bess-kci', notes: 'Unusual: major solar farm on Tasmanian central highlands. DCCEEW announcement labels as solar only; DB has it as Weasel Solar + BESS.' },
    // SA (1 project)
    { name: 'Whyte Yarcowie Wind Farm', developer: 'EDF Power Solutions', technology: 'wind', capacity_mw: 289, state: 'SA', project_id: 'whyte-yarcowie', contract_status: 'awarded', notes: 'SA\'s only T7 winner. EDF\'s first of two T7 wins (Banana Range QLD the other).' },
    // VIC (2 projects — both wind)
    { name: 'Willatook Wind Farm', developer: 'ENGIE', technology: 'wind', capacity_mw: 338, state: 'VIC', project_id: 'willatook', contract_status: 'awarded', notes: 'Victoria sought only wind projects in T7. DB has full project = 450 MW.' },
    { name: 'Woolsthorpe Wind Farm', developer: 'ICA Partners', technology: 'wind', capacity_mw: 72, state: 'VIC', project_id: 'woolsthorpe-wind-farm', contract_status: 'awarded', notes: 'Mexican construction conglomerate ICA Partners — smallest T7 winner.' },
  ],
