...
export const CIS_PROJECTS: Record<string, SchemeProject[]> = {
  ...
  'cis-tender-4-nem-gen': [
    ...
    { name: 'Punchs Creek Renewable Energy Project', developer: 'EDPR + QIC (JV)', technology: 'hybrid', capacity_mw: 400, storage_mwh: 1600, state: 'QLD', contract_status: 'awarded', project_id: 'punchs-creek-renewable-energy-t4', notes: 'Single integrated hybrid project (400 MWac solar + 400 MW / 1,600 MWh BESS). EDPR + QIC JV. FC expected 2026; commissioning early 2029. Part of EDP\'s 1.7 GW Aus fast-track pipeline (also incl. Merino NSW). Consolidated project record created 2026-07-18 (v3.22.4) — replaces stale punchs-creek-hybrid-stage-2/3-kci records (200+600 MW BESS) that predate the T4 consolidated award scope. SkyLab\'s legacy "Punch and Creek" 87 MW is a separate project.' },
    ...
    { name: 'Willogoleche 2 Wind Farm', developer: 'ENGIE (25%) + Foresight Group (75%) JV', technology: 'wind', capacity_mw: 108, state: 'SA', contract_status: 'awarded', project_id: 'willogoleche-2-wind-farm', notes: 'Expansion of operating Willogoleche 1 (119 MW commissioned 2019). Construction late 2026, commissioning 2028. Same ENGIE/Foresight JV structure as Willogoleche 1. $65k/yr community fund. Separate project record created 2026-07-18 (v3.22.4) — Stage 2 now properly distinct from Stage 1 operating.' },
  ],
  'cis-tender-7-nem-gen': [
    ...
    { name: 'Moranbah Solar Farm', developer: 'Zero-E Australia (Grupo Cobra / ACS)', technology: 'hybrid', capacity_mw: 171, storage_mwh: 100, state: 'QLD', contract_status: 'awarded', project_id: 'moranbah-solar-farm-zeroe', notes: 'Zero-E Australia is subsidiary of Spanish Grupo Cobra (ACS Group). Near Coppabella in Bowen Basin. AEMO 5.3.4A connection approval secured pre-award (145 MWac inverter rating per pv-tech; DCCEEW/CIS T7 cites 171 MW — likely DC vs AC distinction). AC-coupled hybrid with grid-forming inverters. Grupo Cobra\'s first Australian clean-energy asset. Cultural Heritage + Shared Benefits agreements with Barada Barna Traditional Owners. Grupo Cobra\'s second T7 win (with Gunning Solar Hybrid NSW). AURES record created 2026-07-18 (v3.22.4).' },
    ...
    { name: 'Cellars Hill Wind Farm', developer: 'Gamuda Renewables Australia + Alternate Path (JV)', technology: 'wind', capacity_mw: 341, state: 'TAS', contract_status: 'awarded', project_id: 'cellars-hill-wind-farm', notes: 'JV between Gamuda Renewables Australia (subsidiary of Malaysian Gamuda Berhad) and Alternate Path (Tasmanian developer). Located Highland Lakes Rd near Bothwell, Central Highlands, ~1hr from Hobart. Shares site + 220 kV connection with sister Weasel Solar. Both delivered via Gamuda Engineering EPC contract. Construction target 2028 (Weasel first, early 2027). Only two Tasmanian T7 projects. AURES record created 2026-07-18 (v3.22.4).' },
  ...
  // ---------------------------------------------------------------
  {
    ...
    t9CompetitiveFieldDeepDive: {
      ...
      deliverabilityFrame: {
        ...
        withdrawResubmit: 'HARDENED per CIS T9 Q&A Item 8 (July 2026): Prior CIS winners are excluded from rebidding T9 on the same project unless the proponent has (a) formally notified the Commonwealth IN WRITING of withdrawal from the prior CISA, or (b) received written confirmation from the Commonwealth that negotiations have ceased. Three sharp implications: (1) Formal written notification is a prerequisite for re-entry — being in commercial discussions or publicly signalling intent does NOT satisfy the test. (2) AEMO retains discretion to consider "track record of not executing binding commitments" — additional scoring penalty even for compliant withdrawals. (3) Withdrawal may constitute a Significant Event under the Proforma CISA (formal notification + remediation plan + prevention strategy + independent legal advice recommended). Bowen\'s 24 June 2026 "welcome to withdraw and bid again" framing turned out to require substantially more machinery than the language implied. See companion Research Note "cis-rebid-restrictions-hardening" (2026-07-07) for the full T9 Q&A Item 8 documentation.',
      },
      lenses: [
        {
          id: 'rebid',
