...
const M_TRANSITION: LearningModule = {
  ...
  description:
    'The modern NEM is the product of a structural reform that started in 1991 and a series of state-by-state privatisations that ran 1992-2014 — and the four corporate empires (AGL, Origin, EnergyAustralia, Alinta) that grew up inside it. This 11-lesson module walks through the pre-NEM era, each state\'s privatisation path (with deep treatment of why Queensland kept GOCs), the rise of the gentailer business model, and full profiles of the four organisations that dominate generation and retail today — including AGL\'s 187-year arc from Sydney gas streetlights through Loy Yang (Fukushima trigger) and Macquarie Generation to the 2022 demerger battle. Closes with the 2030-2035 coal exit schedule.',
  status: 'available',
  readingTime: '130 min',
  accent: '#0ea5e9',
  added: '2026-05-11',
