...
const M_REZ: LearningModule = {
  id: 'nsw-rez',
  icon: '🗺️',
  title: 'NSW Renewable Energy Zones',
  tagline: 'CWO, NE, SW, Hunter-Central Coast, Illawarra — different rules, different fates.',
  description:
    'NSW has five declared Renewable Energy Zones, but they are not interchangeable. Each has its own access scheme, project mix, transmission lead time and cost-recovery model. This module compares them head-to-head — Central-West Orana vs South-West vs New England in particular — and explains why projects in each face fundamentally different commercial conditions.',
  status: 'in-development',
  ...
  buildOrder: 2,
  lessons: [
    { id: 'overview', number: 1, title: 'The NSW REZ framework', summary: 'EII Act 2020, the Consumer Trustee, network operators, and what a REZ actually is.', covers: ['Electricity Infrastructure Investment Act 2020', 'AEMO Services as Consumer Trustee', 'EnergyCo as infrastructure planner', 'Why NSW chose REZs and what UK / Texas equivalents look like'] },
    { id: 'cwo', number: 2, title: 'Central-West Orana (CWO)', summary: 'The first REZ — 4.5 GW target, anchor transmission project, and the projects in the queue.', covers: ['CWO Transmission Project (CWO-TP)', 'Access scheme and access rights', 'Anchor projects (Liverpool Range, Wellington, Spicers Creek, Valley of the Winds)', 'Cost recovery and consumer impact'] },
    { id: 'newengland', number: 3, title: 'New England REZ', summary: 'The big one — 8 GW target. New England transmission package and why timelines have moved.', covers: ['New England REZ Transmission Project', 'Access scheme tender', 'Project mix (large wind farms dominate)', 'Hunter Power Project alignment'] },
    { id: 'southwest', number: 4, title: 'South-West REZ', summary: 'Solar-and-storage heavy, lower wind resource, different access model. Compare to CWO/NE.', covers: ['South-West REZ design', 'Project mix tilted to solar + BESS', 'EnergyConnect interconnector role', 'Why timelines differ'] },
    { id: 'hcc-illawarra', number: 5, title: 'Hunter-Central Coast & Illawarra REZs', summary: 'Coal-replacement focus and offshore-wind interface.', covers: ['Hunter-Central Coast — Eraring/Vales context', 'Illawarra — offshore wind nexus', 'Industrial demand co-location'] },
    { id: 'compare', number: 6, title: 'Compare-the-pair: which REZ to develop in', summary: 'A structured comparison: capacity factors, access cost, transmission lead time, planning friction.', covers: ['Resource quality (CF) by zone', 'Access fee mechanics', 'Network charge differences', 'Planning friction (LGA + community sentiment)'], interactive: 'REZ-by-REZ comparison table' },
    { id: 'outlook', number: 7, title: 'Outlook & risks', summary: 'Where each REZ is in the build-out, recent transmission delays, and what to watch.', covers: ['HumeLink delivery risk', 'EnergyConnect commissioning', 'CWO-TP critical path', 'Cost-recovery impact on retail'] },
  ],
  sources: [
...
const M_BESS: LearningModule = {
  id: 'bess-story',
  icon: '🔋',
  title: 'The BESS Story in the NEM',
  tagline: 'From Hornsdale to 8-hour storage — the rise, the records, the future.',
  description:
    'Five years ago, batteries were a curiosity. Today they set the marginal price in 32% of NEM dispatch intervals (Q1 2026). This module tells the BESS story end-to-end: the first projects, the records each state has set, the duration evolution from 1-hour to 8-hour+, and the AEMO ISP’s view of where the fleet is heading. Heavy use of AURES BESS records leaderboard data.',
  status: 'in-development',
  readingTime: '55 min planned',
  accent: '#22c55e',
  added: '2026-05-10',
  buildOrder: 3,
  lessons: [
    { id: 'origins', number: 1, title: 'Origins: Hornsdale and the world’s biggest battery', summary: 'How a Twitter bet brought 100 MW / 129 MWh to South Australia and broke the orthodoxy.', covers: ['Sep 2016 SA blackout context', 'Tesla / Neoen / Musk bet', 'Hornsdale 100 MW commissioning Dec 2017', 'Frequency-response revenue surprise', '2019 expansion to 150 MW / 193.5 MWh'] },
    { id: 'arbitrage', number: 2, title: 'How a battery actually earns', summary: 'Energy arbitrage, FCAS, capacity payments, contracted offtake. Real numbers from AURES.', covers: ['Spread = avg discharge price - avg charge price', 'Round-trip efficiency 80–88%', 'Cycles per year', 'FCAS market revenue mix', 'Why 1-hour batteries dominated FCAS first'] },
    { id: 'records', number: 3, title: 'BESS records by state', summary: 'Largest, longest, most cycles, biggest spread. AURES leaderboard live data.', covers: ['Eraring Big Battery, Waratah Super Battery (NSW)', 'Wallerawang, Smithfield, Liddell', 'Victorian Big Battery, Hazelwood, Mortlake', 'Riverina, Bouldercombe, Wandoan (QLD)', 'Tailem Bend, Torrens Island (SA)'], interactive: 'AURES leaderboard cross-link' },
    { id: 'duration', number: 4, title: 'The duration evolution', summary: '1-hour → 2-hour → 4-hour → 8-hour. The economics behind each move.', covers: ['Why 1-hour led', 'CIS dispatchable rounds and 4-hour minimum', 'LTESA Round 6 → 8.7 to 11.5 hour batteries', 'Long-duration storage tier'] },
    { id: 'pricesetting', number: 5, title: 'BESS as price-setter', summary: 'Q1 2026 — batteries set price 32% of intervals. What that means for revenue and for thermal generators.', covers: ['Marginal price-setting frequency', 'Cannibalisation of own arbitrage', 'Thermal revenue collapse', 'Future: storage stacking + curtailment recovery'] },
    { id: 'outlook', number: 6, title: 'Where the fleet is heading', summary: 'AEMO ISP storage targets, the LDS gap, 2030 implications.', covers: ['ISP step-change vs progressive scenarios', '~28 GWh NSW LDES target by 2034', 'CIS Tender 6 (WA) and federal-state interplay', 'Inverter-based resource limits'] },
  ],
  sources: [
